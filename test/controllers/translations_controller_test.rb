...
class TranslationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create translation" do
    assert_difference('Translation.count') do
      post translations_url, params: { translation: { interpolations: @translation.interpolations, is_proc: @translation.is_proc, key: @translation.key, locale: @translation.locale, value: @translation.value } }
    end
  ...
  test "should update translation" do
    patch translation_url(@translation), params: { translation: { interpolations: @translation.interpolations, is_proc: @translation.is_proc, key: @translation.key, locale: @translation.locale, value: @translation.value } }
